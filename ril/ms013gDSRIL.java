...
/**
 * RIL customization for Galaxy Grand2 Double-sim devices
 *
 * {@hide}
 */
public class ms013gDSRIL extends RIL implements CommandsInterface {
    ...
    public ms013gDSRIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        this(context, preferredNetworkType, cdmaSubscription);
    }

    public ms013gDSRIL(Context context, int networkMode, int cdmaSubscription) {
